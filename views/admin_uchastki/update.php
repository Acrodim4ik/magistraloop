...
<div class="container">
  ...
  <h4 class="text-center">Редактирование участка</h4>
  ...
  <form method="POST" class="add-uchastok border border-secondary">
    ...
    <div class="form-row">
      <div class="form-group col-md-1">
        ...
        <input type="text" readonly name="uchastok_id" class="form-control" id="uchastok_id" value="<?= $uchastok['uchastok_id'] ?>">
      </div>
    ...
    <div class="form-check">
	    <label class="form-check-label">
	      ...
	      <input class="form-check-input" type="checkbox" name="private" <?=$uchastok['private'] == 'Да' ? 'checked':'';?>  value='Да'> Приватизирован
	    </label>
  </div>
